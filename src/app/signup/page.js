        ...
        <>
            <div className="font-[sans-serif] bg-gray-50 flex items-center md:h-screen p-4">
                <div className="w-full max-w-3xl max-md:max-w-xl mx-auto">
                    <div
                        className="bg-white grid md:grid-cols-2 gap-12 w-full sm:p-8 p-6 shadow-md rounded-md overflow-hidden">
                            ...
                            <div className="space-y-4">
                                <button type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22px" fill="#fff"
                                         className="inline shrink-0 mr-3" viewBox="0 0 167.657 167.657">
                                        <path
                                ...
                                <button type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22px" fill="#fff"
                                         className="inline shrink-0 mr-3" viewBox="0 0 512 512">
                                        <path fill="#fbbd00"
                        ...
                        <form className="w-full">
                            ...
                            <p className="text-gray-800 text-sm mt-4 text-center">Already have an account? <a

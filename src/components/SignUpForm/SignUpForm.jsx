...
export function SignUpForm() {
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input mt-5 bg-white dark:bg-black">
      ...
      <form className="my-8" action = {handleSignUp}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="firstname">First name</Label>
            <Input id="firstname" placeholder="Tyler" name = "firstname" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
        ...
        <LabelInputContainer className="mb-8">
          ...
          <Input id="twitterpassword" placeholder="••••••••" type="password" name = "twitter_password" />
        </LabelInputContainer>

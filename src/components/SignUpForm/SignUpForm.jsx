    ...
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input mt-5 bg-white dark:bg-black">
      ...
      <form className="my-8">
        ...
        <div className="flex flex-col space-y-4">
          <SocialLoginButton icon={<IconBrandGithub className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />} text="GitHub" />
          <SocialLoginButton icon={<IconBrandGoogle className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />} text="Google" />
